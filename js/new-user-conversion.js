...
const BROWSE_FOLLOWUP_MESSAGES = {
  ...
  domains: {
    ...
    fr: `🌐 <b>Ces domaines ne resteront pas longtemps !</b>\n\nDomaines blindés avec gestion DNS complète.\n\n🔥 À partir de <b>$30</b>.\n\n👇 /start → 🌐 Domaines`,
    zh: `🌐 <b>域名不会一直等你！</b>\n\n防封域名，完整DNS管理。\n\n🔥 低至 <b>$30</b>。\n\n👇 /start → 🌐 防封域名`,
    hi: `🌐 <b>वे डोमेन हमेशा नहीं मिलेंगे!</b>\n\nपूर्ण DNS प्रबंधन के साथ बुलेटप्रूफ डोमेन।\n\n🔥 <b>$30</b> से शुरू।\n\n👇 /start → 🌐 डोमेन`,
  },
  cloudphone: {
