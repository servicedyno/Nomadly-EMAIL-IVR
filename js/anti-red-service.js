...
function generateIPFixPhp() {
  return `<?php
// Anti-Red: Restore real visitor IP behind Cloudflare proxy
...
// Cloudflare sends the real visitor IP in CF-Connecting-IP header
if (!empty(\$_SERVER['HTTP_CF_CONNECTING_IP'])) {
    \$_SERVER['REMOTE_ADDR'] = \$_SERVER['HTTP_CF_CONNECTING_IP'];
}
// Fallback: some setups use X-Forwarded-For
