...
बिल्कुल <b>${priceCrypto} ${tickerView}</b> भेजें:\n\n<code>${address}</code>\n\nक्रिप्टो भुगतान तेज़ी से पुष्टि होते हैं — आमतौर पर कुछ ही मिनटों में। पुष्टि होने पर आपको तुरंत सूचना दी जाएगी और आपके वॉलेट को अपडेट किया जाएगा।\n\nसादर,\n${CHAT_BOT_NAME}`,
 ...
 antiRedDisabled: domain => `❌ <b>${domain}</b> के लिए Anti-Red सुरक्षा <b>अक्षम</b>।\n\n⚠️ <b>यह Cloudflare एज-स्तर के सभी स्कैनर ब्लॉकिंग को हटा देता है</b> (Worker route, IP cloaking, anti-bot नियम)। स्टैटिक HTML पेज बिना किसी चैलेंज के सर्व होते हैं — Google Safe Browsing और अन्य crawlers अब आपकी असली साइट देख सकते हैं।\n\n🕒 <b>ऑटो रीइनेबल:</b> exposure कम रखने के लिए हम सुरक्षा को <b>24 घंटे</b> में स्वचालित रूप से वापस ON कर देंगे।\n\nPHP-स्तरीय चैलेंज (.php पर auto_prepend) सक्रिय है लेकिन यह स्टैटिक .html फाइलों को कवर <i>नहीं</i> करता।`,
 antiRedDisableConfirm: domain => `🚨 <b>पुष्टि करें: ${domain} के लिए Visitor Captcha बंद करें</b>\n\nयह करेगा:\n• इस डोमेन की रक्षा करने वाला Cloudflare Worker route हटा देगा\n• Google Safe Browsing, VirusTotal, PhishTank और 30+ अन्य स्कैनर्स के विरुद्ध cloaking बंद कर देगा\n• आपकी असली साइट को <i>किसी भी</i> visitor को expose कर देगा\n\n🕒 सुरक्षा <b>24 घंटे में ऑटोमेटिकली वापस ON</b> हो जाएगी।\n\nजोखिम समझते हैं तो नीचे <code>DISABLE</code> (कैपिटल में) टाइप करें।\n\nया ↩️ Back करें।`,
 antiRedDisableConfirmWrong: 'बंद करने के लिए आपको ठीक <code>DISABLE</code> (कैपिटल) टाइप करना होगा। रद्द करने के लिए ↩️ Back करें।',
 antiRedAutoReenabled: domain => `🛡️ <b>ऑटो रीइनेबल:</b> 24 घंटे की ग्रेस अवधि के बाद <b>${domain}</b> के लिए Visitor Captcha वापस ON कर दी गई है।`,
 ...
 antiRedStatusOff: domain => `🛡️ <b>${domain}</b> के लिए <b>Anti-Red सुरक्षा</b>\n\nस्थिति: <b>❌ बंद</b>\n\n⚠️ <b>इस डोमेन के लिए सभी Cloudflare एज-स्तर स्कैनर ब्लॉकिंग बंद है।</b> स्टैटिक HTML पेज बिना चैलेंज के सर्व होते हैं — Google Safe Browsing और अन्य crawlers असली कंटेंट देख सकते हैं।\n\n🕒 आपकी सुरक्षा के लिए <b>24 घंटे</b> में ऑटो रीइनेबल। अभी चालू करने के लिए नीचे टैप करें।`,
