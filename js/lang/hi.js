...
बिल्कुल <b>${priceCrypto} ${tickerView}</b> भेजें:\n\n<code>${address}</code>\n\nक्रिप्टो भुगतान तेज़ी से पुष्टि होते हैं — आमतौर पर कुछ ही मिनटों में। पुष्टि होने पर आपको तुरंत सूचना दी जाएगी और आपके वॉलेट को अपडेट किया जाएगा।\n\nसादर,\n${CHAT_BOT_NAME}`,
 ...
 cp_10: (TRIAL_CALLER_ID) => `📢 <b>त्वरित IVR कॉल — निःशुल्क परीक्षण</b>\n\n🎁 You get <b>1 निःशुल्क परीक्षण कॉल!</b>\n📱 कॉलर ID: <b>${TRIAL_CALLER_ID}</b> (shared)\n\nCall a single number with an automated IVR message.\n\nEnter the phone number to call (देश कोड के साथ):\n<i>उदाहरण: +12025551234</i>`,
 ...
 cp_115: 'Please enter between 1 and 1440 मिनट.',
 ...
 cp_12: '📞 <b>बल्क IVR अभियान</b>\\n\\nCall multiple नंबर with an automated IVR message.\\nUpload a CSV of leads and launch a campaign.\\n\\n☎️ = Bulk IVR capable नंबर\\n\\n📱 चुनें the कॉलर ID:',
 ...
 cp_141: '📝 <b>Generate ऑडियो from टेम्पलेट</b>\\n\\nChoose a टेम्पलेट श्रेणी, or write your own custom script:',
 ...
 cp_15: '📞 <b>New IVR Call</b>\\n\\nSelect the number to call FROM (कॉलर ID):',
 ...
 cp_20: (presetName, currentPlan) => `🔒 <b>प्रीसेट "${presetName}" uses OTP Collection</b>, which requires the <b>Business</b> plan.\n\nYour current plan: <b>${currentPlan}</b>\n\nUpgrade via 🔄 नवीनीकरण / Change प्लान, or create a new call with 🔗 Transfer mode.`,
 ...
 cp_284: '🌐 चुनें the language for your greeting:',
 cp_285: '📝 Type the greeting text:',
 cp_286: (message) => `🌐 चुनें the language for your greeting:\n\n<i>"${message}"</i>`,
 cp_287: '🎙 <b>वॉइस प्रोवाइडर चुनें</b>\\n\\nChoose your TTS engine:',
 cp_288: '🌐 चुनें the language for your greeting:',
 ...
 cp_295: '📝 Type the greeting callers will hear.\\n\\n<i>उदाहरण: "Thank you for calling Nomadly. Press 1 for sales, press 2 for support."</i>',
 ...
 cp_303: '🌐 चुनें the language for your IVR greeting:\\n\\n<i>The template will be automatically translated to your chosen language.</i>',
 cp_304: '✅ Text updated.\\n\\n🌐 चुनें the language for your IVR greeting:\\n\\n<i>The greeting will be automatically translated to your chosen language.</i>',
 ...
 cp_314: '🌐 चुनें the language for your IVR greeting:',
 cp_315: '📝 Type the greeting callers will hear:',
 cp_316: (message) => `🌐 चुनें the language for your IVR greeting:\n\n<i>"${message}"</i>`,
 ...
 cp_321: '🌐 चुनें the language for your IVR greeting:',
 ...
 cp_33: '⚠️ प्रीसेट audio expired and can\'t be regenerated. Please set up the call manually.',
 ...
 dom_3: (savings, domain, chargeUsd, shownPrice, v4) => `🎉 <b>You saved $${savings}!</b> डोमेन <b>${domain}</b> was registered for <b>$${v4}</b> instead of $${shownPrice}. Only $${chargeUsd} was debited from your wallet.`,
 ...
 dom_5: (domain, domainCost, APP_SUPPORT_LINK) => `Your domain <b>${domain}</b> has been registered successfully, but hosting setup failed. डोमेन cost ($${domainCost}) has been charged. Please contact support to complete your hosting setup: ${APP_SUPPORT_LINK}`,
 ...
 ev_30: '❌ निःशुल्क trial not available for this list size. Please choose a payment method.',
 ...
 sms_36: '❌ नहीं valid phone नंबर found in the file.\\n\\nPlease upload a file with phone नंबर (one per line, starting with + and country code).',
 ...
 sms_44: '❌ Please enter a number between 1 and 300 सेकंड, or tap the button for default.',
 ...
 util_1: (displayName, expiryDate) => `⚠️ <b>VPS समाप्त हो रहा है — नहीं Auto-नवीनीकरण</b>\n\n🖥️ <b>${displayName}</b> समाप्त होता है on <b>${expiryDate}</b>.\nAuto-renewal is <b>OFF</b>.\n\n⏰ <b>नवीनीकरण manually before the deadline</b> or your server will be permanently deleted.\n\nGo to: VPS/RDP → Manage → नवीनीकरण Now`,
 util_10: (toLocaleString, domain, v2, v3, v4) => `🎉 <b>You saved ₦${toLocaleString}!</b> डोमेन <b>${domain}</b> cost ₦${v2} instead of ₦${v3}. The difference of ₦${v4} has been credited to your wallet balance.`,
 util_11: (website_name, round, APP_SUPPORT_LINK) => `Your domain <b>${website_name}</b> has been registered successfully, but hosting setup failed. डोमेन cost has been charged — hosting portion (₦${round}) refunded to your wallet. Please contact support to complete hosting setup: ${APP_SUPPORT_LINK}`,
 ...
 util_9: (domain, ngnPrice) => `💰 <b>Auto-Refund:</b> डोमेन registration for <b>${domain}</b> failed. Your payment of ${ngnPrice} NGN has been credited to your wallet balance.`,
 ...
 vps_3: (totalPrice, toFixed) => `❌ अपर्याप्त शेष राशि. You need $${totalPrice} but have $${toFixed}. Please deposit first.`,
 ...
 wh_13: (toFixed, usdBal) => `❌ VPS provisioning failed.\n\n💰 <b>$${toFixed}</b> has been refunded to your wallet.\nWallet शेष राशि: <b>$${usdBal}</b>\n\nPlease try again or contact support.`,
 wh_14: (domain, price) => `💰 <b>Auto-Refund:</b> डोमेन registration for <b>${domain}</b> failed. $${price} has been credited to your wallet balance.`,
 wh_15: (savingsUsd, domain, cheaperPrice, price, v4) => `🎉 <b>You saved $${v4}!</b> डोमेन <b>${domain}</b> cost $${cheaperPrice} instead of $${price}. The difference of $${savingsUsd} has been credited to your wallet balance.`,
 wh_16: (website_name, domainPrice, toFixed, APP_SUPPORT_LINK) => `Your domain <b>${website_name}</b> has been registered successfully, but hosting setup failed. डोमेन cost ($${domainPrice}) charged — hosting portion ($${toFixed}) refunded to your wallet. Please contact support to complete hosting setup: ${APP_SUPPORT_LINK}`,
 wh_17: '✅ Crypto payment received!',
 wh_18: (countryName) => `✅ Crypto payment received!\n\n📍 <b>${countryName}</b> requires address verification for number activation.\n\nPlease enter your full address:\n<code>Street, City, Postal Code, Country</code>\n\n<i>उदाहरण: 42 Hamilton Ave, Bryanston, 2191, South Africa</i>\n\nOnce submitted, we'll handle the telecom verification process and activate your number automatically.`,
 wh_19: (countryName, text) => `✅ Crypto payment received!\n\n📍 <b>${countryName}</b> requires a billing address to activate the number.\nAddress ${text}.\n\nPlease enter your address:\n<code>Street, City, Country</code>\n\nExample: <i>123 Main St, Sydney, Australia</i>`,
 wh_2: (domain, price) => `💰 <b>Auto-Refund:</b> डोमेन registration for <b>${domain}</b> failed. $${price} has been credited to your wallet balance.`,
 ...
 wh_3: (savingsUsd, domain, cheaperPrice, price, v4) => `🎉 <b>You saved $${v4}!</b> डोमेन <b>${domain}</b> cost $${cheaperPrice} instead of $${price}. The difference of $${savingsUsd} has been credited to your wallet balance.`,
 wh_4: (website_name, domainPrice, toFixed, APP_SUPPORT_LINK) => `Your domain <b>${website_name}</b> has been registered successfully, but hosting setup failed. डोमेन cost ($${domainPrice}) charged — hosting portion ($${toFixed}) refunded to your wallet. Please contact support to complete hosting setup: ${APP_SUPPORT_LINK}`,
