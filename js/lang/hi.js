...
बिल्कुल <b>${priceCrypto} ${tickerView}</b> भेजें:\n\n<code>${address}</code>\n\nक्रिप्टो भुगतान तेज़ी से पुष्टि होते हैं — आमतौर पर कुछ ही मिनटों में। पुष्टि होने पर आपको तुरंत सूचना दी जाएगी और आपके वॉलेट को अपडेट किया जाएगा।\n\nसादर,\n${CHAT_BOT_NAME}`,
 ...
 visitorCaptchaGoldOnly: domain => `🔒 <b>${domain}</b> के लिए <b>विज़िटर Captcha</b>\n\nयह सुविधा केवल <b>👑 Golden Anti-Red HostPanel</b> प्लान के लिए है।\n\nप्रति-डोमेन विज़िटर Captcha सक्षम करने के लिए Golden में अपग्रेड करें।`,
 visitorCaptchaNoHosting: domain => `⚠️ <b>विज़िटर Captcha</b> केवल Golden Anti-Red HostPanel प्लान वाले डोमेन के लिए उपलब्ध है।\n\nडोमेन: <b>${domain}</b>\n\nGolden Anti-Red HostPanel में अपग्रेड करें।`,
