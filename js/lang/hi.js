...
संपर्क: ${CHAT_BOT_NAME}`,
  ...
  showDepositCryptoInfoDigitalProduct: (priceCrypto, tickerView, address, product) =>
    `कृपया ${priceCrypto} ${tickerView} भेजें\n\n<code>${address}</code>\n\n<b>${product}</b> के लिए आपका ऑर्डर प्रोसेस हो रहा है। क्रिप्टो लेनदेन में 30 मिनट तक लग सकते हैं। पुष्टि होने पर, आपका ऑर्डर <b>30 मिनट</b> के भीतर डिलीवर किया जाएगा।\n\nसादर,\n${CHAT_BOT_NAME}`,
...
const l = {
  continueAtHostbay: '🚀 सभी सेवाएं अब Nomadly Bot पर उपलब्ध हैं — डोमेन, लीड्स, CloudPhone, डिजिटल उत्पाद और बहुत कुछ।',
  redirectMessage: '🚀 सभी सेवाएं अब Nomadly Bot पर उपलब्ध हैं — डोमेन, लीड्स, CloudPhone, डिजिटल उत्पाद और बहुत कुछ।',
