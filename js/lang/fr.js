...
${CHAT_BOT_NAME}`,
 ...
 visitorCaptchaGoldOnly: domain => `🔒 <b>Captcha Visiteur</b> pour <b>${domain}</b>\n\nCette fonctionnalité est exclusive aux plans <b>👑 Golden Anti-Red HostPanel</b>.\n\nMettez à niveau vers Golden pour activer le Captcha Visiteur par domaine.`,
 visitorCaptchaNoHosting: domain => `⚠️ <b>Captcha Visiteur</b> est uniquement disponible pour les domaines avec un plan Golden Anti-Red HostPanel.\n\nDomaine : <b>${domain}</b>\n\nMettez à niveau vers Golden Anti-Red HostPanel.`,
