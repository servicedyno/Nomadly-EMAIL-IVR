...
${CHAT_BOT_NAME}`,
 ...
 Weekly: 'Hebdomadaire',
 addSubdomain: 'Ajouter un sous-domaine',
 antiRedDisabled: domain => `❌ Protection Anti-Red <b>désactivée</b> pour <b>${domain}</b>.\n\n⚠️ <b>Cela supprime TOUT le blocage des scanners au niveau du bord Cloudflare</b> (route Worker, masquage IP, règles anti-bot). Les pages HTML statiques sont servies sans aucun challenge — Google Safe Browsing et autres crawlers voient maintenant le contenu réel.\n\n🕒 <b>Réactivation auto :</b> nous réactiverons automatiquement la protection dans <b>24 heures</b> pour limiter l'exposition. Vous pouvez la réactiver manuellement à tout moment.\n\nLe challenge PHP (auto_prepend sur <code>.php</code>) reste actif mais ne couvre <i>pas</i> les fichiers <code>.html</code> statiques.`,
 antiRedDisableConfirm: domain => `🚨 <b>Confirmer : désactiver la Visitor Captcha pour ${domain}</b>\n\nCela va :\n• Supprimer la route Cloudflare Worker protégeant ce domaine\n• Cesser le masquage contre Google Safe Browsing, VirusTotal, PhishTank et 30+ autres scanners\n• Exposer le contenu réel à <i>tout</i> visiteur — y compris les crawlers anti-phishing\n\n🕒 La protection sera <b>réactivée automatiquement dans 24 h</b>.\n\nSi vous comprenez le risque, tapez le mot <code>DISABLE</code> (en majuscules) ci-dessous pour confirmer.\n\nOu touchez ↩️ Retour pour garder la protection ACTIVÉE.`,
 antiRedDisableConfirmWrong: 'Vous devez taper <code>DISABLE</code> (en majuscules) exactement pour désactiver. Touchez ↩️ Retour pour annuler.',
 antiRedAutoReenabled: domain => `🛡️ <b>Réactivation auto :</b> la Visitor Captcha pour <b>${domain}</b> a été réactivée après la période de grâce de 24 h.`,
 ...
 antiRedStatusOff: domain => `🛡️ <b>Protection Anti-Red</b> pour <b>${domain}</b>\n\nStatut : <b>❌ DÉSACTIVÉ</b>\n\n⚠️ <b>Tout le blocage des scanners au niveau du bord Cloudflare est désactivé pour ce domaine.</b> Les pages HTML statiques sont servies sans challenge — Google Safe Browsing, VirusTotal et autres crawlers voient le contenu réel.\n\n🕒 Réactivation automatique dans <b>24 h</b> pour votre protection. Touchez ci-dessous pour réactiver maintenant.`,
