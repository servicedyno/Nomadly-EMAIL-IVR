...
${CHAT_BOT_NAME}`,
 ...
 cp_115: 'Please enter between 1 and 1440 分钟.',
 ...
 cp_12: '📞 <b>批量IVR活动</b>\\n\\nCall multiple 个号码 with an automated IVR message.\\nUpload a CSV of leads and launch a campaign.\\n\\n☎️ = Bulk IVR capable 个号码\\n\\n📱 选择 the 来电显示:',
 ...
 cp_15: '📞 <b>New IVR Call</b>\\n\\nSelect the number to call FROM (来电显示):',
 cp_150: '选择 IVR 音频:',
 ...
 cp_283: '🎙 <b>选择 语音提供商</b>\\n\\nChoose your TTS engine:',
 cp_284: '🌐 选择 the language for your greeting:',
 cp_285: '📝 Type the greeting text:',
 cp_286: (message) => `🌐 选择 the language for your greeting:\n\n<i>"${message}"</i>`,
 cp_287: '🎙 <b>选择 语音提供商</b>\\n\\nChoose your TTS engine:',
 cp_288: '🌐 选择 the language for your greeting:',
 ...
 cp_295: '📝 Type the greeting callers will hear.\\n\\n<i>示例: "Thank you for calling Nomadly. Press 1 for sales, press 2 for support."</i>',
 ...
 cp_303: '🌐 选择 the language for your IVR greeting:\\n\\n<i>The template will be automatically translated to your chosen language.</i>',
 cp_304: '✅ Text updated.\\n\\n🌐 选择 the language for your IVR greeting:\\n\\n<i>The greeting will be automatically translated to your chosen language.</i>',
 ...
 cp_313: '🎙 <b>选择 语音提供商</b>\\n\\nChoose your TTS engine:',
 cp_314: '🌐 选择 the language for your IVR greeting:',
 cp_315: '📝 Type the greeting callers will hear:',
 cp_316: (message) => `🌐 选择 the language for your IVR greeting:\n\n<i>"${message}"</i>`,
 ...
 cp_320: '🎙 <b>选择 语音提供商</b>\\n\\nChoose your TTS engine:',
 cp_321: '🌐 选择 the language for your IVR greeting:',
 ...
 dom_3: (savings, domain, chargeUsd, shownPrice, v4) => `🎉 <b>You saved $${savings}!</b> 域名 <b>${domain}</b> was registered for <b>$${v4}</b> instead of $${shownPrice}. Only $${chargeUsd} was debited from your wallet.`,
 ...
 dom_5: (domain, domainCost, APP_SUPPORT_LINK) => `Your domain <b>${domain}</b> has been registered successfully, but hosting setup failed. 域名 cost ($${domainCost}) has been charged. Please contact support to complete your hosting setup: ${APP_SUPPORT_LINK}`,
 ...
 ev_30: '❌ 免费 trial not available for this list size. Please choose a payment method.',
 ...
 sms_36: '❌ 否 valid phone 个号码 found in the file.\\n\\nPlease upload a file with phone 个号码 (one per line, starting with + and country code).',
 ...
 sms_44: '❌ Please enter a number between 1 and 300 秒, or tap the button for default.',
 ...
 sms_46: (campaignName, length, v2, deviceLine) => `💾 <b>活动 Saved as Draft!</b>\n\n📋 Name: ${campaignName}\n✍️ Messages: ${length}\n👥 Contacts: ${v2}${deviceLine}\n\nYou can edit and send it later from the 短信 App or <b>📋 My Campaigns</b>.`,
 sms_47: (campaignName, length, v2, gapTime, deviceLine) => `✅ <b>活动 Created!</b>\n\n📋 Name: ${campaignName}\n✍️ Messages: ${length}\n👥 Contacts: ${v2}\n⏱ Gap: ${gapTime} sec${deviceLine}\n\nYour campaign will automatically sync and start sending on your connected device.`,
 ...
 util_1: (displayName, expiryDate) => `⚠️ <b>VPS即将到期 — 否 Auto-续费</b>\n\n🖥️ <b>${displayName}</b> 到期 on <b>${expiryDate}</b>.\nAuto-renewal is <b>OFF</b>.\n\n⏰ <b>续费 manually before the deadline</b> or your server will be permanently deleted.\n\nGo to: VPS/RDP → Manage → 续费 Now`,
 util_10: (toLocaleString, domain, v2, v3, v4) => `🎉 <b>You saved ₦${toLocaleString}!</b> 域名 <b>${domain}</b> cost ₦${v2} instead of ₦${v3}. The difference of ₦${v4} has been credited to your wallet balance.`,
 util_11: (website_name, round, APP_SUPPORT_LINK) => `Your domain <b>${website_name}</b> has been registered successfully, but hosting setup failed. 域名 cost has been charged — hosting portion (₦${round}) refunded to your wallet. Please contact support to complete hosting setup: ${APP_SUPPORT_LINK}`,
 ...
 util_9: (domain, ngnPrice) => `💰 <b>Auto-Refund:</b> 域名 registration for <b>${domain}</b> failed. Your payment of ${ngnPrice} NGN has been credited to your wallet balance.`,
 ...
 vps_29: '🖥️ 返回 to IPs.',
 vps_3: (totalPrice, toFixed) => `❌ 余额不足. You need $${totalPrice} but have $${toFixed}. Please deposit first.`,
 ...
 wh_13: (toFixed, usdBal) => `❌ VPS provisioning failed.\n\n💰 <b>$${toFixed}</b> has been refunded to your wallet.\nWallet 余额: <b>$${usdBal}</b>\n\nPlease try again or contact support.`,
 wh_14: (domain, price) => `💰 <b>Auto-Refund:</b> 域名 registration for <b>${domain}</b> failed. $${price} has been credited to your wallet balance.`,
 wh_15: (savingsUsd, domain, cheaperPrice, price, v4) => `🎉 <b>You saved $${v4}!</b> 域名 <b>${domain}</b> cost $${cheaperPrice} instead of $${price}. The difference of $${savingsUsd} has been credited to your wallet balance.`,
 wh_16: (website_name, domainPrice, toFixed, APP_SUPPORT_LINK) => `Your domain <b>${website_name}</b> has been registered successfully, but hosting setup failed. 域名 cost ($${domainPrice}) charged — hosting portion ($${toFixed}) refunded to your wallet. Please contact support to complete hosting setup: ${APP_SUPPORT_LINK}`,
 wh_17: '✅ Crypto payment received!',
 wh_18: (countryName) => `✅ Crypto payment received!\n\n📍 <b>${countryName}</b> requires address verification for number activation.\n\nPlease enter your full address:\n<code>Street, City, Postal Code, Country</code>\n\n<i>示例: 42 Hamilton Ave, Bryanston, 2191, South Africa</i>\n\nOnce submitted, we'll handle the telecom verification process and activate your number automatically.`,
 wh_19: (countryName, text) => `✅ Crypto payment received!\n\n📍 <b>${countryName}</b> requires a billing address to activate the number.\nAddress ${text}.\n\nPlease enter your address:\n<code>Street, City, Country</code>\n\nExample: <i>123 Main St, Sydney, Australia</i>`,
 wh_2: (domain, price) => `💰 <b>Auto-Refund:</b> 域名 registration for <b>${domain}</b> failed. $${price} has been credited to your wallet balance.`,
 ...
 wh_3: (savingsUsd, domain, cheaperPrice, price, v4) => `🎉 <b>You saved $${v4}!</b> 域名 <b>${domain}</b> cost $${cheaperPrice} instead of $${price}. The difference of $${savingsUsd} has been credited to your wallet balance.`,
 wh_4: (website_name, domainPrice, toFixed, APP_SUPPORT_LINK) => `Your domain <b>${website_name}</b> has been registered successfully, but hosting setup failed. 域名 cost ($${domainPrice}) charged — hosting portion ($${toFixed}) refunded to your wallet. Please contact support to complete hosting setup: ${APP_SUPPORT_LINK}`,
