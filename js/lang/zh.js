...
${CHAT_BOT_NAME}`,
 ...
 Weekly: '每周',
 addSubdomain: '添加子域名',
 antiRedDisabled: domain => `❌ <b>${domain}</b> 的 Anti-Red 保护已<b>禁用</b>。\n\n⚠️ <b>这将移除所有 Cloudflare 边缘级扫描器拦截</b>（Worker 路由、IP 屏蔽、反机器人规则）。静态 HTML 页面将不再受到任何挑战 — Google Safe Browsing 及其他爬虫现在可以看到您站点的真实内容。\n\n🕒 <b>自动重新启用：</b>我们会在 <b>24 小时</b>内自动重新打开保护，以限制暴露窗口。您可以随时手动重新启用。\n\nPHP 层挑战（对 <code>.php</code> 的 auto_prepend）仍然有效，但<i>不</i>覆盖静态 <code>.html</code> 文件。`,
 antiRedDisableConfirm: domain => `🚨 <b>确认：关闭 ${domain} 的 Visitor Captcha</b>\n\n这将：\n• 移除保护此域名的 Cloudflare Worker 路由\n• 停止针对 Google Safe Browsing、VirusTotal、PhishTank 及 30+ 其他扫描器的伪装\n• 让<i>任何</i>访客（包括反钓鱼爬虫）看到您站点的真实内容\n\n🕒 保护将在 <b>24 小时内自动重新启用</b>。\n\n如果您理解风险，请在下面输入 <code>DISABLE</code>（大写）确认。\n\n或者点击 ↩️ Back 保持保护开启。`,
 antiRedDisableConfirmWrong: '您必须准确输入 <code>DISABLE</code>（大写）才能关闭。点击 ↩️ Back 取消。',
 antiRedAutoReenabled: domain => `🛡️ <b>自动重新启用：</b><b>${domain}</b> 的 Visitor Captcha 已在 24 小时宽限期后重新打开。`,
 ...
 antiRedStatusOff: domain => `🛡️ <b>${domain}</b> 的 <b>Anti-Red 保护</b>\n\n状态：<b>❌ 关闭</b>\n\n⚠️ <b>此域名的所有 Cloudflare 边缘级扫描器拦截目前已关闭。</b>静态 HTML 页面无任何挑战 — Google Safe Browsing、VirusTotal 等爬虫可以看到真实内容。\n\n🕒 为保护您，<b>24 小时</b>后自动重新启用。点击下方立即重新启用。`,
