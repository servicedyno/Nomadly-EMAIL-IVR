...
${CHAT_BOT_NAME}`,
 ...
 visitorCaptchaGoldOnly: domain => `🔒 <b>访客验证码</b> 用于 <b>${domain}</b>\n\n此功能仅限 <b>👑 Golden Anti-Red HostPanel</b> 套餐。\n\n升级到 Golden 套餐以启用按域名访客验证码控制。`,
 visitorCaptchaNoHosting: domain => `⚠️ <b>访客验证码</b> 仅适用于 Golden Anti-Red HostPanel 套餐的域名。\n\n域名：<b>${domain}</b>\n\n请升级到 Golden Anti-Red HostPanel。`,
