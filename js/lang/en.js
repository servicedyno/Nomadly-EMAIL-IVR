...
Service delivered.`,
 ...
 antiRedStatusOn: domain => `🛡️ <b>Visitor Captcha</b> for <b>${domain}</b>\n\nStatus: <b>✅ ON</b>\n\nVisitors see a brief "Verifying your browser" check that blocks scanners, scrapers and headless bots before they can reach your site.\n\n⚠️ <b>Recommendation:</b> Keep it ON for maximum protection against automated scanners and red-flag triggers.`,
 antiRedStatusOff: domain => `🛡️ <b>Visitor Captcha</b> for <b>${domain}</b>\n\nStatus: <b>❌ OFF</b>\n\n⚠️ <b>All Cloudflare edge-level scanner blocking is currently OFF for this domain.</b> Static .html pages are served without any challenge — Google Safe Browsing, VirusTotal, PhishTank and other crawlers can see the real content of your site.\n\n🕒 Auto re-enables after <b>24 h</b> for your protection. Tap below to re-enable now.`,
 ...
 antiRedDisabled: domain => `❌ Visitor Captcha <b>disabled</b> for <b>${domain}</b>.\n\n⚠️ <b>This removes ALL Cloudflare edge-level scanner blocking</b> (Worker route, scanner-IP cloaking, anti-bot rules). Static HTML pages will be served without any challenge — Google Safe Browsing and other crawlers can now see your real site content.\n\n🕒 <b>Auto re-enable:</b> we'll automatically turn protection back ON in <b>24 hours</b> to limit exposure. You can re-enable manually anytime.\n\nThe PHP-level challenge (auto_prepend on <code>.php</code> requests) is still active but it does <i>not</i> cover static <code>.html</code> files.`,
 antiRedDisableConfirm: domain => `🚨 <b>Confirm: Turn OFF Visitor Captcha for ${domain}</b>\n\nThis will:\n• Remove the Cloudflare Worker route protecting this domain\n• Stop cloaking against Google Safe Browsing, VirusTotal, PhishTank, McAfee, Norton, Sucuri and 30+ other scanners\n• Expose your real site content to <i>any</i> visitor — including automated phishing-detection crawlers\n\n🕒 Protection will <b>auto-re-enable in 24 h</b> regardless of your choice, to limit exposure window.\n\nIf you understand the risk, type the word <code>DISABLE</code> (in capitals) below to confirm.\n\nOr tap ↩️ Back to keep protection ON.`,
 antiRedDisableConfirmWrong: 'You must type <code>DISABLE</code> (in capitals) exactly to turn off Visitor Captcha. Tap ↩️ Back to abort.',
 antiRedAutoReenabled: domain => `🛡️ <b>Auto re-enabled:</b> Visitor Captcha for <b>${domain}</b> has been turned back ON after the 24 h grace period.\n\nThis protects your site against automated scanners. Toggle it off again from My Hosting Plans if you really need to, but expect another auto re-enable in 24 h.`,
