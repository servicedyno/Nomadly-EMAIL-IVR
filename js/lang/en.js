...
Service delivered.`,
 ...
 visitorCaptchaGoldOnly: domain => `🔒 <b>Visitor Captcha</b> for <b>${domain}</b>\n\nThis feature is exclusive to <b>👑 Golden Anti-Red HostPanel</b> plans.\n\nYour current plan does not include the Visitor Captcha toggle. Upgrade to Golden Anti-Red HostPanel to enable per-domain bot protection.\n\nTap <b>⬆️ Upgrade Plan</b> from your hosting plan view to switch.`,
 visitorCaptchaNoHosting: domain => `⚠️ <b>Visitor Captcha</b> is only available for domains attached to a Golden Anti-Red HostPanel plan.\n\nDomain: <b>${domain}</b> is not on a Golden plan.\n\nUpgrade to Golden Anti-Red HostPanel to enable Visitor Captcha for this domain.`,
