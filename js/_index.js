...
bot?.on('message', async msg => {
  ...
  if (action === a.bulkSetConcurrency) {
    ...
    const preview = [
      ...
      bulkData.callerType === 'telnyx' ? `⚠️ <i>Telnyx number — Twilio may reject. Use Twilio number for reliability.</i>` : null,
      bulkData.twilioSubAccountSid ? `🔑 Using Twilio sub-account` : null,
      `📞 Leads: <b>${leadCount}</b>`,
