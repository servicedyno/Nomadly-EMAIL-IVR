...
- Base: `https://prod-isolation-env.preview.emergentagent.com`

## SMS App Web URL
- Browser test: `https://prod-isolation-env.preview.emergentagent.com/api/sms-app-web`

## Hosting Panel
- **URL**: `https://prod-isolation-env.preview.emergentagent.com/panel`
