...
- Base: `https://test-bot-deploy.preview.emergentagent.com`

## SMS App Web URL
- Browser test: `https://test-bot-deploy.preview.emergentagent.com/api/sms-app-web`

## Hosting Panel
- **URL**: `https://test-bot-deploy.preview.emergentagent.com/panel`
