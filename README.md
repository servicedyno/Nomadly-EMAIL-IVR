...
- Example: `https://integration-platform-11.preview.emergentagent.com/api`
...
2. Must end with `/api` — e.g., `https://integration-platform-11.preview.emergentagent.com/api`
